  ...
  return rows
    ...
    .map(r => {
      ...
      return {
        ...
        montHT: get('MONT HT', 'MONT_HT', 'MONTANT_HT', 'MONTHT') != null ? Number(get('MONT HT', 'MONT_HT', 'MONTANT_HT', 'MONTHT')) || 0 : null,
        montTTC: get('MONT TTC', 'MONT_TTC', 'MONTANT_TTC', 'MONTTTC') != null ? Number(get('MONT TTC', 'MONT_TTC', 'MONTANT_TTC', 'MONTTTC')) || 0 : null,
